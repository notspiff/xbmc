...
#include <stdarg.h>
#include <string>
#include "addons/kodi-addon-dev-kit/kodi/libKODI_adsp.h"
#include "addons/binary/callbacks/AudioDSP/api-level-1/AddonCallbacksAudioDSP.h"
...
DLLEXPORT void* ADSP_register_me(void *hdl)
{
  ...
  {
    cb = (ADSPLIB::V1::CB_ADSPLib*)((AddonCB*)hdl)->ADSPLib_RegisterMe(((AddonCB*)hdl)->addonData);
    if (!cb)
