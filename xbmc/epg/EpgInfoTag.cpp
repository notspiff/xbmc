...
using namespace EPG;
using namespace PVR;
using namespace PVRLIB::V2; // namespace here used direct to prevent translation
...
CEpgInfoTag::CEpgInfoTag(void) :
    ...
    m_iYear(0),
    m_epg(NULL),
    m_iFlags(PVRLIB::V2::EPG_TAG_FLAG_UNDEFINED) // Namespace entry here can be removed after remove of level 1
{
}
...
CEpgInfoTag::CEpgInfoTag(const PVRLIB::V2::EPG_TAG &data) :
    m_bNotify(false),
    m_iBroadcastId(-1),
    m_iGenreType(0),
    m_iGenreSubType(0),
