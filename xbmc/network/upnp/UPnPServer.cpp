                               ...
                               const PLT_HttpRequestContext& context)
{
    ...
    if (id.StartsWith("musicdb://")) {
      ...
      if (!database.GetTvShowsByWhere("videodb://tvshows/titles/?local", CDatabase::Filter(), items, SortDescription(), needDetails)) {
        action->SetError(800, "Internal Error");
        return NPT_SUCCESS;
      }
      ...
      if (!database.GetMoviesByWhere("videodb://movies/titles/?local", CDatabase::Filter(), items, SortDescription(), needDetails)) {
        action->SetError(800, "Internal Error");
        return NPT_SUCCESS;
      }
      ...
      if (!database.GetEpisodesByWhere("videodb://tvshows/titles/?local", CDatabase::Filter(), items, true, SortDescription(), needDetails)) {
        action->SetError(800, "Internal Error");
        return NPT_SUCCESS;
      }
      items.SetPath("videodb://tvshows/titles/");
      ...
      if (!database.GetMusicVideosByWhere("videodb://musicvideos/titles/?local", CDatabase::Filter(), items, true, SortDescription(), needDetails)) {
        action->SetError(800, "Internal Error");
        return NPT_SUCCESS;
      }
