...
{
public:
  explicit CDemuxStreamAudioFFmpeg(AVStream* stream) : m_parent(nullptr), m_stream(stream) {}
  std::string GetStreamName() override;
...
{
public:
  explicit CDemuxStreamSubtitleFFmpeg(AVStream* stream) : m_parent(nullptr), m_stream(stream) {}
  std::string GetStreamName() override;
