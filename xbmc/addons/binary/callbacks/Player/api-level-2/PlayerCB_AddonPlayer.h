...
extern "C"
{
  ...
  public:
    ...
    static bool PlayFileItem(void *addonData, PLAYERHANDLE handle, const GUILIB::V2::GUIHANDLE listitem, bool windowed);
  ...
  {
  friend class CPlayerCB_AddonPlayer;
  public:
