...
typedef void* (*KODIPlayerLib_RegisterLevel)(void *addonData, int level);
typedef void (*KODIPlayerLib_UnRegisterMe)(void *addonData, void *cbTable);
...
typedef struct AddonCB
{
  ...
  KODIPlayerLib_RegisterLevel       PlayerLib_RegisterLevel;
  KODIPlayerLib_UnRegisterMe        PlayerLib_UnRegisterMe;
...
namespace ADDON
{
  ...
  public:
    ...
    /*\_________________________________________________________________________
    \*/
    static void*        PlayerLib_RegisterMe           (void* addonData);
    static void*        PlayerLib_RegisterLevel        (void* addonData, int level);
    static void         PlayerLib_UnRegisterMe         (void* addonData, void* cbTable);
    static int          PlayerLib_APILevel();
    static int          PlayerLib_MinAPILevel();
    static std::string  PlayerLib_Version();
    static std::string  PlayerLib_MinVersion();
    void*               PlayerLib_GetHelper()         { return m_helperPlayer; }
    /*\_________________________________________________________________________
    \*/
