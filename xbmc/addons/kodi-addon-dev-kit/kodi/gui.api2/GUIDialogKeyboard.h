...
namespace V2
{
  ...
  ///
  /// \defgroup CAddonGUIDialogKeyboard
  /// \ingroup GUILIB
  /// @{
  ...
  ///
  /// It has the header \ref GUIDialogKeyboard.h "#include <kodi/gui.api2/GUIDialogKeyboard.h>"
  ...
  public:
     ///
     /// \ingroup CAddonGUIDialogKeyboard
     /// @brief Show keyboard with initial value `text` and replace with result string.
     ///
     /// @param text Overwritten with user input if return=true.
     /// @param heading String shown on dialog title.
     /// @param allowEmptyResult Whether a blank password is valid or not.
     /// @param hiddenInput The inserted input is not shown as text.
     /// @param autoCloseMs To close the dialog after a specified time, in milliseconds, default is 0 which keeps the dialog open indefinitely.
    ...
    static bool ShowAndGetInput(
     ...
     ///
     /// \ingroup CAddonGUIDialogKeyboard
     /// @brief The example shows the display of keyboard call dialog at Kodi from the add-on.
     /// @param text Overwritten with user input if return=true.
     /// @param hiddenInput The inserted input is not shown as text.
     /// @param autoCloseMs To close the dialog after a specified time, in milliseconds, default is 0 which keeps the dialog open indefinitely.
     /// @return true if successful display and user input. false if unsuccessful display, no user input, or canceled editing.
    ...
    static bool ShowAndGetInput(
     ...
     ///
     /// \ingroup CAddonGUIDialogKeyboard
     /// @brief Shows keyboard and prompts for a password. Differs from `ShowAndVerifyNewPassword()` in that no second verification
    ...
    static bool ShowAndVerifyNewPassword(
     ...
     /// \ingroup CAddonGUIDialogKeyboard
     /// @brief Show keyboard twice to get and confirm a user-entered password string.
     /// @param newPasswor Overwritten with user input if return=true.
     /// @param autoCloseMs To close the dialog after a specified time, in milliseconds, default is 0 which keeps the dialog open indefinitely.
     /// @return true if successful display and user input. false if unsuccessful display, no user input, or canceled editing.
     ///
    static bool ShowAndVerifyNewPassword(
     ...
     /// @param password Value to compare against user input.
     /// @param heading String shown on dialog title.
    ...
    static int ShowAndVerifyPassword(
     ...
     /// @param text Overwritten with user input if return=true.
     /// @param searchingUse dialog for search and send our search message in safe way (only the active window needs it)
    ...
    static bool ShowAndGetFilter(
     ...
     /// @param text Overwritten with user input if return=true.
     /// @param closeKeyboard The open dialog is if also closed on 'true'.
     /// @return true if successful done, false if unsuccessful or keyboard not present
     ///
...
#include "internal/libKODI_guilib_DialogKeyboardTail.h"
