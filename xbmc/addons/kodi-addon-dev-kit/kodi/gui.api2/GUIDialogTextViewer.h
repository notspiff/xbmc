...
#include "internal/libKODI_guilib_DialogTextViewerHead.h"
...
namespace V2
{
  ...
  ///
  /// \ingroup GUILIB
  /// \defgroup CAddonGUIDialogTextViewer
  /// @{
  ...
  ///
  /// It has the header \ref GUIDialogTextViewer.h "#include <kodi/gui.api2/GUIDialogTextViewer.h>"
  /// be included to enjoy it.
  ///
  /// \image html help.GUIDialogTextViewer.png
  ///
  class CAddonGUIDialogTextViewer
  {
  public:
    ///
    /// \ingroup CAddonGUIDialogTextViewer
    /// @brief Show info text dialog
    ///
    /// @param heading  Small heading text
    /// @param text     Showed text on dialog
    ///
    /// <b>Code example:</b>
    /// \code
...
#include "internal/libKODI_guilib_DialogTextViewerTail.h"
