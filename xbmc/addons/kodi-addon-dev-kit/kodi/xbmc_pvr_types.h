...
#ifdef PVR_API_LEVELS_ACTIVE
      AddOnLIB::V2::kodi_codec_type iCodecType;         /*!< @brief (required) codec type this stream */
      AddOnLIB::V2::kodi_codec_id   iCodecId;           /*!< @brief (required) codec id of this stream */
#else
