...
\defgroup PVRLIB Library - PVRLIB
\ingroup cpp
\brief <b><em>PVR add-on related functions to pass data on Kodi</em></b>

This library is for PVR add-ons to allow cross talk. Becomes needed to inform
Kodi about changes on the PVR system.

@note This library part is only needed on PVR add-ons, for other types is
nothing inside.
...
\*/
  ...
  ///
  /// It has the header \ref PVRLib.h "#include <kodi/pvr.api2/PVRLib.h>" be included
  /// to enjoy it
  ///
  ...
  public:
    ...
    /// @endcode
    ///
    /// @warning To use the library must be one time the macro IMPLEMENT_KODI_PVR_LIBRARY
    ...
    /// ------------------------------------------------------------------------
    ///
    /// <b>Hook category Id's (PVR_MENUHOOK_CAT):
    ///
    ...
    /// @param[in] bOn True when recording started, false when it stopped
    ///
  ...
  public:
    ...
    ///     ...
    ///
    ///     CPVRLib_Transfer::EpgEntry(handle, &tag);
    ///   }
    ///
    ...
    ///     ...
    ///
    ///     CPVRLib_Transfer::ChannelEntry(handle, &tag);
    ///   }
    ///
    ///   return PVR_ERROR_NO_ERROR;
    /// }
    ...
    ///       ...
    ///
    ///       CPVRLib_Transfer::TimerEntry(handle, &tag);
    ///     }
    ///   }
    ///   return PVR_ERROR_NO_ERROR;
    /// }
    ...
    ///     ...
    ///
    ///     CPVRLib_Transfer::RecordingEntry(handle, &tag);
    ///   }
    ///
    ///   return PVR_ERROR_NO_ERROR;
    /// }
    ...
    ///
    ///     CPVRLib_Transfer::ChannelGroup(handle, &tag);
    ///   }
    ///
    ///   return PVR_ERROR_NO_ERROR;
    /// }
    ...
    ///     tag.iChannelNumber = <YOUR_CHANNEL_NUMBER>;
    ///
    ///     CPVRLib_Transfer::ChannelGroupMember(handle, &tag);
    ///   }
    ///
    ///   return PVR_ERROR_NO_ERROR;
    /// }
  ...
  public:
    ...
    ///
    /// ...
    /// CPVRLib_Trigger::RecordingUpdate();
    /// @endcode
    ///
    ...
    ///
    /// ...
    /// CPVRLib_Trigger::ChannelGroupsUpdate();
    /// @endcode
    ///
