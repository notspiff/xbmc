...
#include "kodi/addon.api2/Codec.h"
...
#include <algorithm>
#include <map>
#include "internal/libKODI_pvr_StreamUtilsHead.h"
...
namespace V2
{
  ...
  /// @endcode
  ///
  /// It has the header \ref StreamUtils.h "#include <kodi/pvr.api2/StreamUtils.h>" be included
  /// to enjoy it.
  ///
  ///
  /// ------------------------------------------------------------------------
  ...
  ///  */
  /// #include <kodi/pvr.api2/StreamUtils.h>
  ///
  /// CStreamProperties activeChannelStreams;
  /// ...
  /// void UpdateStreams()
  /// {
...
#include "internal/libKODI_pvr_StreamUtils.hpp"
